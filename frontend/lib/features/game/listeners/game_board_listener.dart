// Listens to game board changes and triggers controller actions and timer start.
...
class GameBoardListener extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<GameBoardListener> createState() => _GameBoardListenerState();
}

class _GameBoardListenerState extends ConsumerState<GameBoardListener> {
