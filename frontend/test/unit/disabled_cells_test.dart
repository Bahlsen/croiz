...
void main() {
  ...
  group('Disabled cells', () {
    ...
    test('GameBoardNotifier.setLetter does not write to disabled cells', () async {
      ...
      expect(board.blackCells.isDisabled(0, 3), isTrue, reason: 'Expected black cell at row=0, col=3');

      notifier.setLetter(0, 3, 'X');
      expect(notifier.state.grid[0][3], isNull, reason: 'setLetter should ignore black cells');

      // Ensure writing to a non-black cell works
      const r = 0, c = 0; // part of word SOL in sample 5x5
